      ...
      <View style={{ height: "75%", width: "100%" }}>
        ...
        >
            ...
            <View style={{ flexDirection: "column" }}>
              ...
              <View style={styles.tableBody}>
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, name: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, trade: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, mon: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, tues: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, wed: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, fri: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, sat: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, sun: txt })
                    }
                ...
                <View style={styles.inputWeekBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setDataLabour({ ...dataLabour, total: txt })
                    }
            ...
            <View style={{ flexDirection: "column" }}>
              ...
              <View style={styles.tableBody}>
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setMaterialData({ ...materialData, quantity: txt })
                    }
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setMaterialData({ ...materialData, unit: txt })
                    }
            ...
            <View style={{ flexDirection: "column" }}>
              ...
              <View style={styles.tableBody}>
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setPlantData({ ...plantData, quantity: txt })
                    }
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setPlantData({ ...plantData, unit: txt })
                    }
            ...
            <View style={{ flexDirection: "column" }}>
              ...
              <View style={styles.tableBody}>
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setManagmentData({ ...managmentData, quantity: txt })
                    }
                ...
                <View style={styles.inputMaterialBodyContainer}>
                  <TextInput
                    onChangeText={(txt) =>
                      setManagmentData({ ...managmentData, unit: txt })
                    }
          ...
          <View>
            ...
            >
              I/We certify that this is a true record of the works carried out
              and the materials used to undertake the work.
            </Text>
          </View>
          <View>
          ...
          >
            ...
            >
              Please ensure a copy of this sheet is returned to Top Dec office
              for processing. Payments will not be made without this sheet{" "}
            </Text>
          </View>
          <View
            style={{
