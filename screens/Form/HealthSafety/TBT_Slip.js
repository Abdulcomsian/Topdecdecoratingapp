...
const TBTSlip = (props) => {
  ...
  const [coshhArray, setCoshhArray] = useState([
    {
      mainTitle: "Slips, trips and falls",
      title:
    ...
    {
      title:
        "•	If cables have to be routed at floor level, try to avoid pedestrian walkways.",
    },
    {
      title:
...
const mapDispatchToProps = (dispatch) => ({
  creatTbtSlipHandler: (data, token, index) =>
    dispatch(insertTbtSlip(data, token, index)),
