...
const IssueCard = (props) => {
  ...
  const issueRecordForm = async () => {
    ...
    try {
      if (contractorName && projectName && nameOfOperative && dynamicInput) {
          ...
          <ScrollView>
            <View style={styles.formCodnatiner}>
              ...
              >
                ...
                REASONABLE STEPS TO ENSURE PPE IS PROPERLY USED IN ACCORDANCE
                WITH THE TRAINING RECEIVED. ANY LOSS OR DEFECT OF THE P.P.E TO
              ...
              >
                ...
                assessments when undertaking the work or using a particular tool
                or equipment. This in accordance to the training I have
                received.
              </Text>
              <Text
                style={{
              ...
              >
                ...
                maintained in accordance with instruction given. When not in use
                my PPE will be kept secure in accommodation provided or as
                advised.
              </Text>
              <Text
                style={{
