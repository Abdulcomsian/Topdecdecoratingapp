...
const TBTWORKING = () =>{
    ...
    const [coshhArray,setCoshhArray]=useState([
        {mainTitle:"Work at Height:",title:"Falling from height is the biggest cause of fatalities in the construction industry. Many of these deaths and injuries are as a result of falling less than 2 metres. All such deaths and serious injuries are preventable."},
        ...
        {mainTitle:"Points to Remember: ",title:"•	Access ladders must be secured and extend sufficiently beyond working platforms to allow for safe access/egress."},
        ...
        {title:"•	If guard-rails, fragile surface covers, void protections etc, are removed for any reason then they must be replaced as soon as possible, and in the interim should be physically guarded."},
    ...
    const addToolBox = () =>(
        setToolBoxArray(oldArray=>[...oldArray,{name:"",sign:"",date:""}])
    )
