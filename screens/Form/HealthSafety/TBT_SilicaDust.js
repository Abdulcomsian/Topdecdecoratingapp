...
const TBTSLICIA = () =>{
    ...
    const [coshhArray,setCoshhArray]=useState([
        {title:"Silica is a natural substance found in most rocks, sand and clay and in products such as concrete and bricks. In the workplace, these materials create dust when disturbed such as by:"},
        ...
        {title:"Dusts can be fine enough to be inhaled deeply into your lungs. This can cause harm to your health. The fine dust is called respirable crystalline silica (RCS) and is too fine to see with normal lighting."},
        ...
        {mainTitle:"Silicosis – ",title:"Exposure to RCS over a number of years can result in silicosis – this makes breathing more difficult and also increases the risk of lung infections. Extreme exposure to RCS can lead rapidly to ill health."},
        {mainTitle:"Lung Cancer – ",title:"Should someone already have silicosis, there is an increased risk of lung cancer. Prolonged and heavy exposure to RCS can also cause lung cancer."},
        {mainTitle:"Chronic Obstructive Pulmonary Disease (COPD) – ",title:"Breathing in fine dusts, such as RCS can lead to COPD – a group of lung diseases that includes emphysema and bronchitis. This results in severe breathlessness, chronic disability and prolonged coughing. COPD is a leading cause of death and cigarette smoking can make it worse."},
        {mainTitle:"Do’s and Don’ts for operators/workers: - ",title:"•	Always follow safe working procedures and cleaning procedures – if you are not sure, stop the job and ask."},
        ...
        {title:"•	Ensure all PPE is adequate for the adequate for the task, free from damage and worn as intended – where respirators are required – face fitting must have been carried out and the operator needs to be clean shaven for these to be effective."},
        ...
        {title:"•	Avoid eating, drinking, and smoking in areas where there is silica dust. A good practice is to first leave the dusty area and wash your hands and face."},
        {title:"•	Avoid bringing dust home. Vacuum the dust from your clothes or change into clean clothing before leaving the work site. Do not brush or blow dust off."},
        {title:"•	Cooperate with employer’s health screening/surveillance processes – this may be carried out by health and working history questionnaires, lung function tests and chest x-rays (if requested by a doctor)."}
    ])
            ...
            <ScrollView>
                <View style={{paddingLeft:20,paddingRight:20}}>
                    ...
                    <View style={styles.validationView}>
                        ...
                        <Text style={{fontFamily:'poppins-regular',fontSize:10}}>After operatives have received the toolbox talk information, the following questions should be asked to ensure that they have understood. </Text>
