...
const Covid = (props) => {
  ...
  const [coshhArray, setCoshhArray] = useState([
    ...
    {
      mainTitle: "DO Not: Go to work if you have:",
      title: "1. Have a high temperature,",
    },
    { title: "2. A new and continuous cough." },
    { title: "3. A loss or change to your sense of smell or taste." },
    {
      mainTitle: "Getting to work – ",
      title:
    ...
    { title: "2. Avoid public transport." },
    {
      mainTitle: "On Site – ",
      title:
        "1.	Face covering is mandatory on-site, if you have a ‘reasonable or medical exemption’ please inform the site team.  Reasonable exemption includes:",
    },
    ...
    {
      title:
        "-	if you suffer from a disability where you are unable to put it on",
    },
    { title: "-	when you need to eat, drink or take medication." },
    { title: "-	If it affects your ability to perform strenuous activity" },
    {
      title:
        "2.	Wash your hands when you arrive on site, regularly throughout the day (especially if you sneeze or cough and after eating or handling food) and again when you leave site. ",
    },
    {
      title:
        "3.	Always keep at least 2 metres away from other workers. This includes while you are working and during breaks and mealtimes – staggered breaks will help achieve this.",
    },
    {
      title:
        "4.	Bring your own meals and refillable drinking bottles. Do not share items (for example, cups, small tools, sundries etc.). ",
    },
    {
      title:
        "5.	Re-usable PPE should be thoroughly cleaned after use and not shared between workers.",
    },
    {
      title:
        "6.	Single use PPE should be disposed of so that it cannot be reused.",
    },
  ]);
            ...
            <>
              ...
              >
                <Text style={styles.titleText}>
                  Tool Box Talk – Coronavirus ( COVID - 19 )
                </Text>
              </View>
              <ScrollView>
                <View style={{ paddingLeft: 20, paddingRight: 20 }}>
                  <Text style={{ fontFamily: "poppins-regular", fontSize: 12 }}>
                    ...
                    - This talk covers the ways to maintain your health while
                    working on-site.{" "}
                  </Text>
                  <Text style={{ fontFamily: "poppins-regular", fontSize: 12 }}>
                    <Text style={{ fontFamily: "poppins-bold", fontSize: 12 }}>
                    ...
                    - Coronavirus is a highly contagious disease that can have
                    severe effects on people, especially those who are
                    vulnerable. The virus is likely to pass from person to
                    person in communal areas and where it is not possible to
                    maintain safe distances between persons. If a person is
                    infected while working, it can be passed on through to
                    families and other contacts. You can spread the virus even
                    if you do not have symptoms.{" "}
                  </Text>
                  <Text style={{ fontFamily: "poppins-regular", fontSize: 12 }}>
                    <Text style={{ fontFamily: "poppins-bold", fontSize: 12 }}>
                      What to do if you think you are ill whilst onsite{" "}
                    </Text>
                    - If you develop a high temperature or a persistent cough
...
const mapDispatchToProps = (dispatch) => ({
  creatTbtCovidHandler: (data, token, index) =>
    dispatch(insertTbtCovid(data, token, index)),
