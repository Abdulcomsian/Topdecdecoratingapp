...
const SafeWorkProcedure = (props) => {
  const [protectiveArray, setProtectivearray] = useState([{ image: mask }, { image: hand }, { image: foot }, { image: eye }, { image: cloth }]);
  const [safetyCheckArray, setSafetyCheckArray] = useState([
    ...
    {
      mainTitle: "OPERATIONAL SAFETY CHECKS / USE",
      title: "Ensure refuelling of generator takes place in a designated area free from ignition sources and sparks.",
    },
    { title: "Ensure the appropriate COSHH Assessment for the product being used is available." },
    {
      title:
        "Personal Protective Equipments – Mask to be 3M (Model 4251) reusable half face mask suitable for vapours. User to be Face fit tested, full coveralls,",
    },
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={{ paddingTop: 30, justifyContent: "center", alignItems: "center" }}>
        ...
        <Text style={{ fontSize: 10, textAlign: "center", fontFamily: "poppins-semiBold" }}>
          Image download failed.Paint Sprayer – Electronic / Petrol powered (Generator){" "}
        </Text>
      </View>
      <View style={styles.warningView}>
        <Text style={{ fontSize: 10, textAlign: "center", fontFamily: "poppins-semiBold" }}>
          <Text style={{ fontSize: 10, textAlign: "center", fontFamily: "poppins-bold", color: "red" }}>DO NOT</Text> use this machine unless you have been
          instructed in its safe use and operation and have been given permission.
        </Text>
      </View>
      <ScrollView>
        <View style={styles.formCodnatiner}>
          ...
          <View>
            ...
            <View>
              <View style={{ flexDirection: "row", width: "100%" }}>
                <Image source={cross} />
                <Text style={{ paddingLeft: 10, fontFamily: "poppins-regular", fontSize: 12 }}>
