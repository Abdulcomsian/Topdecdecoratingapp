...
const TBTFire = () =>{
    ...
    const [coshhArray,setCoshhArray]=useState([
        {mainTitle:"Fire Prevention",title:"•	The Material Safety Datasheets/COSHH assessments will provide you with the relevant information on the product to be used."},
        ...
        {title:"•	Consider potential trespassers. Do not give them a source of fuel or ignition to start a fire (Lock away flammable substances in flam store/container)."},
        ...
        {mainTitle:"Fire Fighting",title:"All fire extinguishers are red but have panels of different colours to indicate their contents: Label Colour Content:"},
