...
const TBTRESPIRATORY = () =>{
    ...
    const [coshhArray,setCoshhArray]=useState([
        {title:"The main benefit of wearing a mask is that it helps prevent you from getting ill and therefore helps keep you working. Specifically, it helps prevent the development of illnesses which could affect your airways – which could reduce the quality and length of your life."},
        {title:"Wearing a mask can stop you from developing the symptoms of respiratory illness caused by inhalation of hazardous substances at work (for example, coughing, wheezing, shortness of breath, chest tightness or difficulty in breathing)."},
        {title:"Also remember that people can be affected differently following exposure to hazardous substances – and, in the case of long-term ill-health – we don’t know who is more likely to become ill (i.e. develop respiratory diseases)."},
        {mainTitle:"Points to Remember:",title:"•	If there are good reasons for having a beard (e.g. for religious reasons), alternative forms of RPE, that do not rely on a tight fit to the face, are available."},
