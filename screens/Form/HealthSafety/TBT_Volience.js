...
const TBTVOLIENCE = () =>{
    ...
    const [coshhArray,setCoshhArray]=useState([
        ...
        {title:"You are required to read and sign our Violence and Aggression at work Policy (a copy will be provided to you by Top Dec Decorating Supervisor) to state you have understood its contents and you shall adhere accordingly."},
    ])
        ...
        <View style={styles.mainContainer}>
            ...
            <ScrollView>
                <View style={{paddingLeft:20,paddingRight:20}}>
                    ...
                    <Text style={{fontFamily:'poppins-bold',fontSize:10,textAlign:"center",paddingTop:10}}>Once completed, please file a copy in the Site Folder and send a copy to our Head Office and a copy should be given to the site team </Text>
                </View>
            </ScrollView>
        </View>
    )
