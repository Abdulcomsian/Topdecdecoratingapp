...
import {userLogin} from '../../Redux/action/auth/authActionTypes';
...
const ForgetPassword = ({props,navigation}) =>{
    ...
    const postSignInHandler = ()=>{
        console.log(email);
        // try{
        //     dispatch(props.userLogin(email,password));
        //   }
        //   catch(err){
...
export default connect(mapStateToProps, { userLogin })(ForgetPassword);
