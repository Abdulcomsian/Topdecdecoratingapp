    ...
    return(
        <View style={styles.mainContainer}>
            ...
            <View style={styles.btnContainer}>
                ...
                <TouchableOpacity style={styles.commonBtn} onPress={() => postCreateSupervisor()}>
                    <Text style={styles.commonText}>Save</Text>
                </TouchableOpacity>
            </View>
        </View>
...
const mapDispatchToProps=dispatch=>({
    createSupervisorHandler:(name,email,password,phone,token)=>dispatch(createSupervisor(name,email,password,phone,token))
  })
