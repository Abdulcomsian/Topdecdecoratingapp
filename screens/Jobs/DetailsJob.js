...
const DetailsJob = (props) => {
  ...
  console.log("searchJobData", props.route.params.searchJobData);
  ...
  const [startDate] = useState(props.route.params.searchJobData.start_date);
  const [supervisorID] = useState(
    props.route.params.searchJobData.supervisor_id
  );
  const [weeks] = useState(props.route.params.searchJobData.weeks);
    ...
    <View style={styles.mainContainer}>
      <View style={styles.dateTimeContainer}>
        <Text style={styles.refText}>
          Date: {props.route.params.searchJobData.created_at.split("T")[0]}
        </Text>
        <Text style={styles.refText}>
          Ref id: {props.route.params.searchJobData.reference_number}
        </Text>
      </View>
